...
<body>
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="3000">
              ...
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img class="d-block w-100" src="https://rawgit.com/creativetimofficial/material-kit/master/assets/img/bg.jpg" alt="First slide">
  ...
  <h1>Inicia sesión o regístrate para poder disfrutar de todos los beneficios de tener una cuenta con nosotros. </h1>
  </div>
  <div class="botonIndex">
    <a href="principal/iniciarsesion.php" class="btn btn-white btn-animation-1">¡Vamos!</a>
  </div>
