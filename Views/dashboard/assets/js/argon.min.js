...
let BarsChart = (function () {
      ...
      (function (a) {
        let e = new Chart(a, {
          ...
          data: {
            ...
            datasets: [{ label: "Sales", data: [20, 20, 30, 22, 17, 29, 30] }],
          },
        });
        a.data("chart", e);
      })(a);
            ...
            datasets: [
              {
                label: "Ventas",
                /* Contenido -> Lugar a modificar para mostrar la gráfica*/
                data: [10, 43, 22, 30, 15, 40, 20, 60, 60, 78, 3, 40],
              },
            ],
          },
        });
  ...
  noUiSlider = (function () {
    if (
      ...
      let a = document.getElementById("input-slider-range"),
