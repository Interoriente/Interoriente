    ...
    a.length &&
      (function (a) {
        let e = new Chart(a, {
          type: "bar",
          data: {
            labels: labelVentasSemana,
            /* Contenido -> Lugar a modificar para mostrar la gráfica*/
            datasets: [{ label: "Ventas", data: datosVentasSemana }],
          },
        });
        a.data("chart", e);
      })(a);
              ...
              yAxes: [
                {
                  ...
                  ticks: {
                    callback: function (a) {
                      ...
                      if (!(a % 10))
                        return "$" + number_format(parseFloat(a), 3, "", ".");
                    },
                  },
                },
              ],
              ...
              callbacks: {
                label: function (a, e) {
                  ...
                  return (
                    ...
                    (o += `$${number_format(parseFloat(t), 3, "", ".")}`)
                  );
                },
              },
            },
