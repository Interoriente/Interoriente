!(function (t, e) {
  ...
  function A(t, e) {
    ...
    switch (e) {
      ...
      case "radio":
        return (
          t.querySelector(".".concat(C.radio, " input:checked")) ||
          t.querySelector(".".concat(C.radio, " input:first-child"))
        );
      case "range":
  ...
  var P,
    ...
    rt = '\n <div aria-labelledby="'
      ...
      .concat(C.close, '">&times;</button>\n   </div>\n   <div class="')
      .concat(C.content, '">\n     <div id="')
      .concat(C.content, '"></div>\n     <input class="')
      ...
      n &&
        ((function (t, e) {
          "string" == typeof e
            ...
            : e ||
              O([document.documentElement, document.body], C["no-backdrop"]);
        })(n, e.backdrop),
        !e.backdrop &&
          e.allowOutsideClick &&
          g(
    ...
    Lt = function () {
      return new Promise(function (t) {
        ...
        (Pt.restoreFocusTimeout = setTimeout(function () {
          Pt.previousActiveElement && Pt.previousActiveElement.focus
            ? (Pt.previousActiveElement.focus(),
  ...
  function Zt(t) {
    ...
    n &&
      ...
      T(n, C.show),
      O(n, C.hide),
      lt && !x(n, C.noanimation)
        ? n.addEventListener(lt, Ft.bind(null, n, e, a))
        : Kt(e, a),
      i(t || {}));
  }
  var Qt = function (t) {
  ...
  var te = function (t) {
      ...
      null !== t.onBeforeOpen &&
        ...
        t.onBeforeOpen(n),
        t.animation && (O(n, C.show), O(e, C.fade)),
        j(n),
        lt && !x(n, C.noanimation)
          ? ((e.style.overflowY = "hidden"),
            n.addEventListener(lt, Gt.bind(null, n, e)))
        ...
        nt() &&
          (t.scrollbarPadding && Ht(),
          (function () {
            if (
              /iPad|iPhone|iPod/.test(navigator.userAgent) &&
              !window.MSStream &&
              !x(document.body, C.iosfix)
            ) {
          ...
          "undefined" != typeof window &&
            Nt() &&
            (Ut(), window.addEventListener("resize", Ut)),
          m(document.body.children).forEach(function (t) {
            t === R() ||
              (function (t, e) {
        ...
        ot() ||
          ...
          (Pt.previousActiveElement = document.activeElement),
        null !== t.onOpen &&
  ...
  var ie,
    re = Object.freeze({
      ...
      setProgressSteps: function (t) {
        ...
        var e = a({}, mt.innerParams.get(this), { progressSteps: t });
      ...
      _main: function (t) {
        ...
        !(function (e) {
          ...
          Object.freeze(l),
          Pt.timeout && (Pt.timeout.stop(), delete Pt.timeout),
        ...
        return new Promise(function (t) {
          ...
          Pt.keydownHandlerAdded &&
            (Pt.keydownTarget.removeEventListener(
              "keydown",
              Pt.keydownHandler,
              { capture: Pt.keydownListenerCapture }
            ),
            ...
            l.toast && (l.input || l.footer || l.showCloseButton)
              ? O(document.body, C["toast-column"])
              : T(document.body, C["toast-column"]),
            ...
            l.toast ||
              (b(l.allowEnterKey)
                ? l.focusCancel && H(d.cancelButton)
                  ? d.cancelButton.focus()
                  : l.focusConfirm && H(d.confirmButton)
                  ? d.confirmButton.focus()
                  : a(-1, 1)
