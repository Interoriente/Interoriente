...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/estilosCatalogoProduct.css">
...
?> 
    <div class="padre">
        <div class="header">
            ...
            <a href="#" class="tit-hdos"><h2>Catálogos</h2></a>
            <i class="fas fa-chevron-right"></i>
            <a href="#" class="tit-hdos"><h2>Productos</h2></a>
        ...
        <a href=""><div class="caja-categorias" background="../../assets/img/tecnologia.jpg">
            <img src="../../assets/img/tecnologia.jpg" alt="" class="img-categorias">
            <h2 class="tit-hdos">Tecnología</h2>
            </div></a>
            <a href=""><div class="caja-categorias">
