...
class Administrador
{
    ...
    public function ActivarUsuario($id)
    {
        ...
        //redireccionar
        echo "<script> document.location.href='../../users/dashboard/principal/usuarios.php';</script>";
    }
                ...
                if ($size > 70000000) {
                    ...
                    if ($tipo_archivo == 'jpg' || $tipo_archivo == 'jpeg' || $tipo_archivo == 'png') {
                        ...
                        if (move_uploaded_file($_FILES['file']['tmp_name'], $archivo)) {
                            ...
                            echo "<script> document.location.href='../../users/dashboard/principal/perfil.php';</script>";
                        } else {
